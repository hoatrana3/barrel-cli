...
2. Including optimization property in `webpack.config.js` to extract common dependencies into chunks based on provided entry points:
...
The compiled entry point and dependency chunks can then be conditional included on template files as needed.
